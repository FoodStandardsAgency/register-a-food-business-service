...
const getRegistrationsByCouncil = async (options) => {
  logEmitter.emit("functionCall", "collections.v5.controller", "getRegistrationsByCouncil");
  ...
  if (validationResult === true) {
    ...
    logEmitter.emit("functionSuccess", "collections.v5.controller", "getRegistrationsByCouncil");
...
const getRegistration = async (options) => {
  logEmitter.emit("functionCall", "collections.v5.controller", "getRegistration");
  ...
  if (validationResult === true) {
    ...
    logEmitter.emit("functionSuccess", "collections.v5.controller", "getRegistration");
...
const getRegistrations = async (options) => {
  logEmitter.emit("functionCall", "collections.v5.controller", "getRegistrations");
  ...
  if (validationResult === true) {
    ...
    logEmitter.emit("functionSuccess", "collections.v5.controller", "getRegistrations");
    return formattedRegistrations;
  } else {
    const error = new Error("");
    error.name = "optionsValidationError";
...
const updateRegistration = async (options) => {
  logEmitter.emit("functionCall", "collections.v5.controller", "updateRegistration");
  ...
  if (validationResult === true) {
    ...
    logEmitter.emit("functionSuccess", "collections.v5.controller", "updateRegistration");
