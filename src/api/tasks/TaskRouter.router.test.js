...
describe("/api/tasks route: ", () => {
    ...
    describe("GET to /bulk/createtascomiregistration", () => {
        ...
        it("Should call sendAllOutstandingRegistrationsToTascomiAction", () => {
            expect(sendAllOutstandingRegistrationsToTascomiAction).toHaveBeenLastCalledWith(
                req, res
            );
        });
    });
    ...
    describe("GET to /bulk/sendnotification", () => {
        ...
        beforeEach(() => {
            router = TaskRouter();
            sendAllNotificationsForRegistrationsAction.mockImplementation((req, res) => {});
    ...
    describe("GET to /bulk/savetotempstore", () => {
        ...
        beforeEach(() => {
            router = TaskRouter();
            saveAllOutstandingRegistrationsToTempStoreAction.mockImplementation((req, res) => {});
        ...
        it("Should call saveAllOutstandingRegistrationsToTempStoreAction", () => {
            expect(saveAllOutstandingRegistrationsToTempStoreAction).toHaveBeenLastCalledWith(
                req, res
            );
        });
    });
