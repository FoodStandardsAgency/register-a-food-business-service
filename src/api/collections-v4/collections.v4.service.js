...
const validateOptions = async (options, unlimitedDateRange) => {
  logEmitter.emit("functionCall", "registrations.v3.service", "validateOptions");
  ...
  logEmitter.emit("functionSuccess", "registrations.v3.service", "validateOptions");
  return true;
};
