...
module.exports = {
  ...
  FINISHED_TRADING_LA_TEMPLATE_ID: process.env.FINISHED_TRADING_LA_TEMPLATE_ID || "TBD",
  STILL_TRADING_LA_TEMPLATE_ID: process.env.STILL_TRADING_LA_TEMPLATE_ID || "TBD",
